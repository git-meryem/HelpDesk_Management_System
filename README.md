...
-  Role-based system (Admin / Agent / User)
-  Create, update, and track tickets
-  Admin & Agent Dashboard
-  Ticket status (Open / In Progress / Closed)
-  Priority levels (Low / Medium / High)
-  Comments system (discussion per ticket)
-  File attachments support
-  Ticket assignment to agents
-  Statistics and charts (Dashboard analytics)
...
<img width="323" height="284" alt="login" src="https://github.com/user-attachments/assets/945389d2-584f-40e2-9ce8-8e31708abc33" />

<img width="249" height="310" alt="register" src="https://github.com/user-attachments/assets/0974047c-8120-4ab9-acc1-5eced0a0aad5" />

<img width="243" height="187" alt="forgot password" src="https://github.com/user-attachments/assets/1244dd52-2493-4d4e-b4e6-af465da91f02" />
